...
class acceuil {
	...
	<article class="container">
		<section class="row">
			<a href="?requete=magazine" class="accueil_ban">
			...
			<a href="?requete=produit" class="accueil_ban">
		...
		<section class="row">
			<a href="?requete=magazine-detail&id=1007" class="accueil_ban">
			...
			<a href="?requete=magazine-detail&id=1001" class="accueil_ban">
