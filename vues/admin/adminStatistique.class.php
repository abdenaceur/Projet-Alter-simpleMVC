...
class AdminStatistique {
	 ...
	 * 
	 */
	public function afficheAdminStatistique() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Statistique</h2>
                <p>Vente totale pour le mois:</p>
                <img src="../img/amazon-1.png">
                
                <p>Vente totale pour la montre la plus vendu:</p>
                <img src="../img/amazon-3.png">
            </aside>
        </article>
