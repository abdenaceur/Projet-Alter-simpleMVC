...
class adminModificationClientConfirmation {
	 ...
	 * 
	 */
	public function afficheAdminModificationClientConfirmation() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Vous avez modifier les information du client avec succès</h2>
            </aside>
        </article>
    </main>
    ...
    public function afficheAdminModificationClientEchec() {
        ?>
        ...
        <main>
            <article class="conteneur">
                ...
                <aside class="droitContent">
                    <h2>La modification n'a pas ete reussi. Veuiller recommencer.</h2>
                </aside>
            </article>
        </main>
    <?php
