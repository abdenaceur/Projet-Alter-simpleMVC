...
class adminCreerClientReponse {
	 ...
	 * 
	 */
	public function afficheAdminCreerClientBonneReponse() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Le client a ete ajouter avec succes.</h2>
                <p>Redirection a l'acceuil</p>
            </aside>
        </article>
    ...
    public function afficheAdminCreerClientPasReponse() {
        ?>
        ...
        <main>
            <article class="conteneur">
                ...
                <aside class="droitContent">
                    <h2>Il y a eu un erreur durant l'ajout du compte client.</h2>
                    <p>Redirection a l'acceuil</p>
                </aside>
            </article>
