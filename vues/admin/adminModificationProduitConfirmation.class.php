...
class adminModificationProduitConfirmation {
	 ...
	 * 
	 */
	public function afficheAdminModificationProduitConfirmation() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Vous avez modifier les information du produit avec succès</h2>
            </aside>
        </article>
    </main>
    ...
    public function afficheAdminModificationProduitEchec() {
        ?>
        ...
        <main>
            <article class="conteneur">
                ...
                <aside class="droitContent">
                    <h2>La modification du produit n'a pas ete reussi. Veuiller recommencer.</h2>
                </aside>
            </article>
        </main>
    <?php
