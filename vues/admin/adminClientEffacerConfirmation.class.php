...
class adminClientEffacerConfirmation {
	 ...
	 * 
	 */
	public function afficheAdminEffacerClientBonneReponse() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Vous avez effacer le client avec succès</h2>
    ...
    public function afficheAdminEffacerClientMauvaiseReponse() {
        ?>
        ...
        <main>
            <article class="conteneur">
                ...
                <aside class="droitContent">
                    <h2>Le client n'a pas ete effacer.</h2>
