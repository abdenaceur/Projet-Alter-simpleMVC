...
class adminCreerProduitReponse {
	 ...
	 * 
	 */
	public function afficheAdminCreerProduitBonneReponse() {
		?>
     ...
     <main>
        <article class="conteneur">
            ...
            <aside class="droitContent">
                <h2>Le produit a ete ajouter avec succes.</h2>
    ...
    public function afficheAdminCreerProduitPasReponse() {
        ?>
        ...
        <main>
            <article class="conteneur">
                ...
                <aside class="droitContent">
                    <h2>Il y a eu un erreur durant l'ajout du produit.</h2>
                    <p>Redirection a l'acceuil</p>
                </aside>
            </article>
