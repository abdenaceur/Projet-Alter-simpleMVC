...
class modeleInformationClient {
	...
	public function getInformationClient()
	{
        ...
        $requete = "SELECT Client_ID,Client_Nom, Client_Prenom, Client_Adresse, Client_Ville, Client_Codepostal, Client_Pays, Client_Tel, Client_Email, Client_NomUtilisateur FROM client WHERE Client_ID = '$numClient'";
